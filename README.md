...
```bash
claude mcp add --env GPTMAKER_API_TOKEN=your_token_here gptmaker -- uvx gptmaker-mcp
```
...
claude mcp add --env GPTMAKER_API_TOKEN=your_token_here gptmaker -- gptmaker-mcp
```
